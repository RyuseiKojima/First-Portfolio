...
<body>
    <div class="wrapper w-100 m-auto">
        ...
        <div class="mx-auto mt-3 w-75 overflow-auto">
            <a href="views/funny.php" class="content-items content-items1 mb-3 float-start position-relative">
                <div class="content-text position-absolute">
                    <h3 class="text-white">Funny</h3>
                </div>
            </a>
            <a href="views/animal.php" class="content-items content-items2 mb-3 float-start position-relative">
                <div class="content-text position-absolute">
                    <h3 class="text-white">Animal</h3>
                </div>
            </a>
            <a href="views/baby.php" class="content-items content-items3 mb-3 float-start position-relative">
                <div class="content-text position-absolute">
                    <h3 class="text-white">Baby</h3>
                </div>
            </a>
            <a href="views/nature.php" class="content-items content-items4 mb-3 float-start position-relative">
                <div class="content-text position-absolute">
