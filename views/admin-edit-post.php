        ...
        <div class="container w-50 mx-auto">
            ...
            <div class="col-10 mx-auto">
                <form action="../actions/post-actions.php?post_id=<?= $_GET['post_id']?>" method="post">
                    ...
                    <button type="submit" name="admin_edit_post" class="btn btn-primary w-100 mb-3 text-uppercase">Post</button>
                </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0">
                    ...
                    <form action="../actions/post-actions.php?post_id=<?= $_GET['post_id']?>" method="post">
                        <button type="submit" class="btn btn-danger" name="admin_delete_post">Delete</button>
                    </form>
                </div>
            </div>
        </div>
